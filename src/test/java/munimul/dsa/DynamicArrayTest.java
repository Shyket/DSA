...
public class DynamicArrayTest {
    ...
    public void testIndexOutOfBounds2() {
        ...
        assertThrows(Exception.class, () -> list.remove(1000));
    }
    ...
    public void testIndexOutOfBounds3() {
        DynamicArray<Integer> list = new DynamicArray<>();
        for (int i = 0; i < 1000; i++) list.add(789);
        assertThrows(Exception.class, () -> list.remove(-1));
    }
    ...
    public void testIndexOutOfBounds4() {
        ...
        assertThrows(Exception.class, () -> list.remove(-66));
    }
    ...
    public void testIndexOutOfBounds6() {
        DynamicArray<Integer> list = new DynamicArray<>();
        for (int i = 0; i < 10; i++) list.add(12);
        assertThrows(IndexOutOfBoundsException.class, () -> list.set(10, 3));
    }
    ...
    public void testIndexOutOfBounds7() {
        DynamicArray<Integer> list = new DynamicArray<>();
        for (int i = 0; i < 10; i++) list.add(12);
        assertThrows(IndexOutOfBoundsException.class, () -> list.set(15, 3));
    }
    ...
    public void testAddingElements() {
        ...
        for (int i = 0; i < elems.length; i++) assertEquals(elems[i], list.get(i).intValue());
    }
    ...
    public void testAddAndRemove() {
        ...
        for (int i = 0; i < 55; i++) list.add(44L);
        for (int i = 0; i < 55; i++) list.remove(0);
        assertTrue(list.isEmpty());
        ...
        for (int i = 0; i < 155; i++) list.add(44L);
        for (int i = 0; i < 155; i++) list.remove(0);
        assertTrue(list.isEmpty());
    }
